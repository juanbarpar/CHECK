...
public class Test_login_Activity extends AppCompatActivity {
    ...
    private void setListeners() {
        binding.buttonSignUp.setOnClickListener(view -> startActivity(new Intent(getApplicationContext(), Test_Sign_Up_Activity.class)));
    ...
    private void signIn() {
        ...
        if (!user.equals("") && !pass.equals("")) {
            tokenAutenticacion.signInWithEmailAndPassword(user, pass).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                @Override
